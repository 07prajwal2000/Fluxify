import type { responseSchema as getAllResponseSchema } from "@fluxify/server/src/api/v1/projects/settings/keys/get-all/dto";
import type {
...
export const projectSettingsKeysService = {
	...
	async upsert(projectId: string, body: UpsertRequestBody): Promise<UpsertResponse> {
