export const STARTERS = [
	{
		label: "CRUD API + JWT",
		prompt: "Generate a blog API with rate limiting, Redis cache and JWT auth.",
	},
	{
		label: "Stripe webhook",
		prompt: "Build a Stripe webhook handler that processes subscription lifecycle events securely.",
	},
	{
