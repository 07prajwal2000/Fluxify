				...
				<Modal.Container placement="center">
					<Modal.Dialog className="w-[38rem] max-w-[92vw]">
						...
						<Modal.Body className="flex flex-col gap-3">
							<div className="flex flex-col gap-1.5">
								...
								<p className="text-xs text-muted">
									JSON is sent as JSON; anything else is sent as plain text. Binary goes as base64
									or hex with a media type saying which — the way an image travels through JSON
									anywhere else.
								</p>
							</div>
						...
						<Modal.Footer className="flex flex-row items-center gap-2">
							<span className="text-xs text-muted">The run is queued and happens on a worker.</span>
