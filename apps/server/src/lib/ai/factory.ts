...
import type { aiVariantSchema } from "../../api/v1/integrations/schemas";

export class AIAdapterFactory {
	static CreateAdapter(variant: z.infer<typeof aiVariantSchema>, config: any): BaseAiIntegration {
		switch (variant) {
			case "OpenAI":
