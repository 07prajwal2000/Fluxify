...
// sort and strict are about which row, and exists only asks whether there is one
export const existsDbBlockSchema = getSingleDbBlockSchema.omit({ sort: true, strict: true });
