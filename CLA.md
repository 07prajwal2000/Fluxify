# Fluxify Contributor License Agreement

Thank you for contributing to Fluxify.

This agreement clarifies the intellectual property licence granted with
contributions from any person or entity. It protects you as a contributor and
protects everyone who relies on the project.

**You keep ownership of your contribution.** This agreement does not transfer
copyright. It grants a licence, so the project can distribute your work and make
licensing decisions without having to track down every past contributor
individually.
...
future Contributions submitted to Fluxify (the "Project"). Except for the
licence granted herein to the Project owner and recipients of software
distributed by the Project, You reserve all right, title, and interest in and to
Your Contributions.

### 1. Definitions

**"You"** (or **"Your"**) means the copyright owner or legal entity authorised
...
> example, offering a commercial licence alongside the open source one, or
> changing the project licence. Without it, any future licensing decision would
> require the written consent of every contributor who ever submitted code.
>
...
1. You are legally entitled to grant the above licence.
...
3. If Your employer has rights to intellectual property that You create, You
   ...
   or Your employer has waived such rights, or Your employer has executed a
...
The Project is under no obligation to accept or include any Contribution.
...
If you are contributing as part of your employment, please make sure your
employer is aware and has approved it. Have your employer contact the
maintainers if a Corporate CLA is required — open a
[discussion](https://github.com/Fluxify-rest/Fluxify/discussions) and we'll
sort it out.
...
If anything here is unclear, ask before signing — open a
[discussion](https://github.com/Fluxify-rest/Fluxify/discussions). We would much
rather explain than have you agree to something you're unsure about.
